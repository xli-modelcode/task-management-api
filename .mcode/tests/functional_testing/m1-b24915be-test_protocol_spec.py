...
Generated at: 2026-03-07T04:50:58.443532+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint returns 200 with status, timestamp, service, and version fields",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "create_task_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/api/v1/tasks",
        "method": "POST",
        "description": "Create a task with all fields provided and verify 201 response with generated ID, default status pending, and Location header",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "create_task_minimal_fields",
        "category": "HAPPY_PATH",
        "endpoint": "/api/v1/tasks",
        "method": "POST",
        "description": "Create a task with only the required title field; verify default priority is medium and tags is empty array",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/api/v1/tasks",
        "method": "POST",
        "description": "Attempt to create a task without the required title field; expect 400 with error response",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
        ...
        "actual_response": {
            "error": {
                ...
                "message": "Key: 'CreateTaskRequest.Title' Error:Field validation for 'Title' failed on the 'required' tag"
            }
        }
    },
    {
        ...
        "endpoint": "/api/v1/tasks",
        "method": "POST",
        "description": "Attempt to create a task with an invalid priority value; expect 400 validation error",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
        ...
        "actual_response": {
            "error": {
                "code": "VALIDATION_ERROR",
                "message": "invalid priority: urgent"
            }
        }
    },
    {
        "name": "get_task_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/api/v1/tasks/{id}",
        "method": "GET",
        "description": "Create a task, then retrieve it by ID and verify all fields match",
        "setup": {
            "endpoint": "/api/v1/tasks",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/v1/tasks/{id}",
        "method": "GET",
        "description": "Attempt to retrieve a task with a non-existent UUID; expect 404 with error response containing NOT_FOUND code",
        "setup": null,
        "request_data": {
            "path": {
    ...
    {
        "name": "get_task_invalid_uuid",
        "category": "NOT_FOUND",
        "endpoint": "/api/v1/tasks/{id}",
        "method": "GET",
        "description": "Attempt to retrieve a task with an invalid non-UUID string; expect 404 since no task matches",
        "setup": null,
        "request_data": {
            "path": {
                "id": "not-a-valid-uuid"
        ...
        "actual_response": {
            "error": {
                "code": "NOT_FOUND",
                "message": "task with ID not-a-valid-uuid not found"
            }
        }
    },
    {
        "name": "delete_task_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/api/v1/tasks/{id}",
        "method": "DELETE",
        "description": "Create a task, then delete it and verify 204 No Content response",
        "setup": {
            "endpoint": "/api/v1/tasks",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/v1/tasks/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a task with a non-existent UUID; expect 404 with NOT_FOUND error",
        "setup": null,
        "request_data": {
            "path": {
                "id": "00000000-0000-0000-0000-000000000000"
    ...
    },
    {
        ...
        "endpoint": "/api/v1/tasks",
        "method": "POST",
        "description": "Attempt to create a task with an empty string title; expect 400 since title requires min length 1",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
